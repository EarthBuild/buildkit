...
func (m *OutputMessage) CloneVT() *OutputMessage {
	if m == nil {
...
func (m *OutputMessage) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *InputMessage) EqualVT(that *InputMessage) bool {
	...
	if string(this.Stdin) != string(that.Stdin) {
		return false
	}
...
func (this *OutputMessage) EqualVT(that *OutputMessage) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *OutputMessage) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*OutputMessage)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *OutputMessage) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *OutputMessage) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *OutputMessage) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *OutputMessage) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *OutputMessage) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
